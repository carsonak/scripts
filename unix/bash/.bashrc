...
betterHistory()
{
    ...
    # Format for history time stamps
...
# shellcheck source=/home/line/.bash_aliases
    . ~/.bash_aliases
fi
...
# bc opts
export BC_LINE_LENGTH=0 # Max line length before folding

# Custom prompt
eval "$(oh-my-posh init bash --config ~/custom_installs/my_custom_prompt.omp.json)"
